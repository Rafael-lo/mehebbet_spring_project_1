...
public class UserServiceImpl implements UserService {
	...
	@Override
	public UserDtls updateUser(UserDtls updatedUserData) {
		return userRepository.save(updatedUserData);
	}

	@Override
	public UserDtls updateUserProfile(UserDtls updatedUserData, MultipartFile img) {
		
		UserDtls dbUser = userRepository.findById(updatedUserData.getId()).get();
		...
		if (!ObjectUtils.isEmpty(dbUser)) {
			dbUser.setName(updatedUserData.getName());
			dbUser.setMobileNumber(updatedUserData.getMobileNumber());
			dbUser.setAddress(updatedUserData.getAddress());
			dbUser.setCity(updatedUserData.getCity());
			dbUser.setState(updatedUserData.getState());
			dbUser.setPincode(updatedUserData.getPincode());
